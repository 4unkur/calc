...
@section('content')
    <div class="row">
        <form class="form col-xs-12 col-md-8 col-lg-4" method="post">
            {{ csrf_field() }}
                        ...
                        <tr class="tr">
                            ...
                            <td class="td">
                                <input type="text" name="{{ $field }}[]"
                                       class="form-control input @if ($errors->has($field . '.' . $i)) alert-danger @endif"
                                       value="{{ old($field . '.' . $i) }}">
                            </td>
                            @endforeach
                        </tr>
            ...
            <button type="submit" class="btn btn-info btn-block calc"><i class="fa fa-heart"> </i> Calculate it, PLEASE!</button>
        </form>

        @if (count($errors))
            <div class="errors col-xs-12 col-md-8 col-lg-4">
